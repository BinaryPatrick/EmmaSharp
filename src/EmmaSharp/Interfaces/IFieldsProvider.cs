...
namespace EmmaSharp
{
    ...
    /// interest is the <see cref="ClearField(string)"/> method which lets you clear out all the data in a single field
    /// for all members in your account. This makes it easy to re-initialize a dataset if you’re looking to correct an
    /// import error or syncing issue
    /// </summary>
